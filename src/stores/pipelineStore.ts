...
const mockProperties: PipelineProperty[] = [
  {
    id: '1',
    user_id: 'user-1',
    address: '14 Albert Road, Manchester, M14 6YL',
    stage: 'identified',
    position: 0,
    notes: '3-bed terrace, quiet street near hospital',
    labels: ['hot'],
    priority: 'high',
    monthly_offer: 1200,
    bedrooms: 3,
  ...
  },
  {
    ...
    activities: [
      ...
      { id: 'a3', type: 'moved', description: 'Moved to Contacted', timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), from_stage: 'Identified', to_stage: 'Contacted' },
    ],
    comments: [
      { id: 'c1', content: 'Landlord interested in guaranteed rent model', user_name: 'You', created_at: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString() },
    ],
    documents: [],
    reminders: [],
  },
  {
    ...
    documents: [],
    reminders: [
      { id: 'r1', title: 'Follow up on pitch response', due_date: '2026-04-05', completed: false },
    ],
  },
  {
    id: '4',
  ...
  },
  {
    id: '5',
    user_id: 'user-1',
    address: '9 Elm Grove, Bristol, BS2 8HU',
    stage: 'live',
    position: 0,
    landlord_name: 'Mrs. Thompson',
    monthly_offer: 1300,
    labels: ['returning'],
    priority: null,
    bedrooms: 3,
